...
(
    ...
    --account_type public.new_account_type NOT NULL,
...
UPDATE 
  inventory 
SET 
  inv_description = REPLACE(inv_description,  'GM Hummer', 'small interiors') 
WHERE 
  inv_id=10;
...
SET 
  ...
  inv_thumbnail = REPLACE(inv_image,  '/image', '/image/vehicle') 